...
import "./CoworkingAllLocation.scss";
...
const CoworkingAllLocation = () => {
  const locationData = [
    {
      img: GolfCourseRoad,
      name: "Golf Course Road",
      url: "/coworking-space-on-golf-course-road",
    },
    {
  ...
  return (
    <section className="coworking_all_location">
...
export default CoworkingAllLocation;
