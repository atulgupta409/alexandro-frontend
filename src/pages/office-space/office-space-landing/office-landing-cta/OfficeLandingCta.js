        ...
        <div className="row align-items-center">
          <div className="col-md-7">
            <div className="cta_content">
              <h4>
                Fast and Simple Way to Buy. Lease Commercial Office Space in
            ...
            <div className="office_form_part">
              <form id="example_form" method="post">
                ...
                <div className="row">
                  ...
                  <div className="col-12">
                    <select class="form-select" name="desktype" id="Desk">
                      <option value="" selected disabled>
                        Office Type
                      </option>
                      <option value="Raw office space">Raw office space</option>
                  ...
                  <div className="col-12">
                    <select class="form-select" name="spaceseat" id="Team">
                      <option value="" selected disabled>
                        Office Size
                      </option>
                      <option value="1000sqft">Upto 1000 sqft</option>
                      <option value="1000 - 3000 sqft">1000 - 3000 sqft</option>
                      <option value="3000 - 5000 sqft">3000 - 5000 sqft</option>
...
export default OfficeLandingCta;
